...
class PassengersControllerTest < ActionController::TestCase
  ...
  test "should create passenger" do
    assert_difference('Passenger.count') do
      post :create, passenger: { documento: @passenger.documento, nacimiento: @passenger.nacimiento, name: @passenger.name }
    end
  ...
  test "should update passenger" do
    patch :update, id: @passenger, passenger: { documento: @passenger.documento, nacimiento: @passenger.nacimiento, name: @passenger.name }
    assert_redirected_to passenger_path(assigns(:passenger))
  end
